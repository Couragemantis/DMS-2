...
Public Class frmPaidPayments
    ...
    Private Sub frmPaidPayments_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadPaidPayments()

        Dim query As String =
            "SELECT payment_id, room_number, electricity_amount, water_amount, " &
            "rental_amount, total_amount, date_created, due_date, date_paid " &
            "FROM payments_paid ORDER BY date_paid DESC"
   ...
   Private Sub btnExportPDF_Click(sender As System.Object, e As System.EventArgs) Handles btnExportPDF.Click
        ...
        saveDialog.Title = "Save Paid Payments Report"
        saveDialog.Filter = "PDF Files (*.pdf)|*.pdf"
        saveDialog.DefaultExt = "pdf"
        saveDialog.AddExtension = True
        saveDialog.FileName = "Paid_Payments_Report_" & pdfNumber & ".pdf"
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        For i As Integer = printColumn To dgvPaidPayments.Columns.Count - 1

            If dgvPaidPayments.Columns(i).Visible Then
                ...
                e.Graphics.DrawString( _
                    dgvPaidPayments.Columns(i).HeaderText, _
                    headerFont, _
                    Brushes.Black, _
                    x + 3, _
                    y + 8)
        ...
        While printRow < dgvPaidPayments.Rows.Count

            If dgvPaidPayments.Rows(printRow).IsNewRow Then
            ...
            For i As Integer = printColumn To dgvPaidPayments.Columns.Count - 1
                ...
                If dgvPaidPayments.Columns(i).Visible Then
                    ...
                    If dgvPaidPayments.Rows(printRow).Cells(i).Value IsNot Nothing Then

                        value = dgvPaidPayments.Rows(printRow).Cells(i).Value.ToString()
