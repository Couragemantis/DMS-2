...
Public Class frmMaintenanceRooms
    ...
    Public Sub LoadMaintenanceRooms()
        Dim query As String = "SELECT room_number, floor_number, status FROM rooms WHERE status = 'Under Maintenance' ORDER BY room_number"

        Using con As New SqlConnection(connectionString)
            Using da As New SqlDataAdapter(query, con)
                Dim dt As New DataTable()
                da.Fill(dt)
                dgvMaintenanceRooms.DataSource = dt
            End Using
        End Using
    End Sub
    Private Sub frmMaintenanceRooms_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnExportPDF_Click(sender As System.Object, e As System.EventArgs) Handles btnExportPDF.Click
        ...
        saveDialog.Title = "Save Maintenance Report"
        saveDialog.Filter = "PDF Files (*.pdf)|*.pdf"
        saveDialog.DefaultExt = "pdf"
        saveDialog.AddExtension = True
        saveDialog.FileName = "Maintenance_Report_" & pdfNumber & ".pdf"
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        For i As Integer = printColumn To dgvMaintenanceRooms.Columns.Count - 1

            If dgvMaintenanceRooms.Columns(i).Visible Then
                ...
                e.Graphics.DrawString( _
                    dgvMaintenanceRooms.Columns(i).HeaderText, _
                    headerFont, _
                    Brushes.Black, _
                    x + 3, _
                    y + 8)
        ...
        While printRow < dgvMaintenanceRooms.Rows.Count

            If dgvMaintenanceRooms.Rows(printRow).IsNewRow Then
            ...
            For i As Integer = printColumn To dgvMaintenanceRooms.Columns.Count - 1
                ...
                If dgvMaintenanceRooms.Columns(i).Visible Then
                    ...
                    If dgvMaintenanceRooms.Rows(printRow).Cells(i).Value IsNot Nothing Then

                        value = dgvMaintenanceRooms.Rows(printRow).Cells(i).Value.ToString()
