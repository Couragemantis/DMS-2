...
Public Class frmRateHistory
    ...
    Private Sub frmRateHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        LoadRateHistory()

    End Sub

    Private Sub LoadRateHistory()

        Dim query As String =
            "SELECT log_id, rate_type, old_value, new_value, date_changed " &
            "FROM rate_logs ORDER BY date_changed DESC"

        Using con As New SqlConnection(connectionString)
            Using da As New SqlDataAdapter(query, con)
                Dim dt As New DataTable()
                da.Fill(dt)
                dgvRateHistory.DataSource = dt
            End Using
        End Using
    ...
    Private Sub btnExportPDF_Click(sender As System.Object, e As System.EventArgs) Handles btnExportPDF.Click
        ...
        saveDialog.Title = "Save Rates Report"
        saveDialog.Filter = "PDF Files (*.pdf)|*.pdf"
        saveDialog.DefaultExt = "pdf"
        saveDialog.AddExtension = True

        saveDialog.FileName = "Rates_Report_" & pdfNumber & ".pdf"
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        For i As Integer = printColumn To dgvRateHistory.Columns.Count - 1

            If dgvRateHistory.Columns(i).Visible Then
                ...
                e.Graphics.DrawString( _
                    dgvRateHistory.Columns(i).HeaderText, _
                    headerFont, _
                    Brushes.Black, _
                    x + 3, _
                    y + 8)
        ...
        While printRow < dgvRateHistory.Rows.Count

            If dgvRateHistory.Rows(printRow).IsNewRow Then
            ...
            For i As Integer = printColumn To dgvRateHistory.Columns.Count - 1
                ...
                If dgvRateHistory.Columns(i).Visible Then
                    ...
                    If dgvRateHistory.Rows(printRow).Cells(i).Value IsNot Nothing Then

                        value = dgvRateHistory.Rows(printRow).Cells(i).Value.ToString()
